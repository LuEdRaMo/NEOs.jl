...
for V in (:Val{true}, Val{false})
    @eval begin
        function apophisinteg(f!, q0::Array{U,1}, t0::T, tmax::T, order::Int, abstol::T, ::$V,
...
function apophisinteg(f!, q0::Array{U,1}, t0::T, tmax::T, order::Int, abstol::T,
    params = nothing; maxsteps::Int=500, parse_eqs::Bool=true) where {T<:Real, U<:Number}
    return apophisinteg(f!, q0, t0, tmax, order, abstol, Val(false), params; maxsteps, parse_eqs)
end
...
for V in (:Val{true}, :Val{false})
    @eval begin
        function apophisinteg(f!, g, q0::Array{U,1}, t0::T, tmax::T, order::Int,
            abstol::T, ::$V, params = nothing; maxsteps::Int=500, parse_eqs::Bool=true,
...
function apophisinteg(f!, g, q0::Array{U,1}, t0::T, tmax::T, order::Int,
    ...
    eventorder::Int=0, newtoniter::Int=10,
    nrabstol::T=eps(T)) where {T <: Real,U <: Number}
    return apophisinteg(f!, g, q0, t0, tmax, order, abstol, Val(false), params;
